...
export const testimonialsData = [
    {
        ...
        name: 'Shoel chowdury',
        title: 'MD',
        text: "We are together already done various fire alram project",
        image: boy2
    },
    {
        id: 2,
        name: 'Monica Geller',
        title: 'Head Chef',
        text: "This is the only thing that I didn't have to spend time to sort out.",
        image: girl2
    },
    {
        id: 3,
        name: 'Asif Qbal',
        title: 'Massuese',
        text: "Mr. Norul is a very Honest person ",
        image: boy1
    },
    {
        id: 4,
